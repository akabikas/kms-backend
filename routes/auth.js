...
router.post('/add-project', authenticateUser, projectController.addProject)
router.put('/update-project', authenticateUser, projectController.updateProject)
router.delete('/delete-project', authenticateUser, projectController.deleteProject)
